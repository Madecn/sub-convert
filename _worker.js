...
var S = (e, r, t) => cr(e, typeof r != "symbol" ? r + "" : r, t), ze = (e, r, t) => r.has(e) || at("Cannot " + t);
...
var Mr = Rt, $r = Nr, Dr = Ir, Hr = Fr, jr = Ur, Br = Pr, E = {
  isNothing: Mr,
  isObject: $r,
  toArray: Dr,
  repeat: Hr,
...
}), W = Object.prototype.hasOwnProperty, Ue = 1, Ft = 2, Ut = 3, Me = 4, Ke = 1, Ki = 2, ut = 3, Ji = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Qi = /[\x85\u2028\u2029]/, Xi = /[,\[\]\{\}]/, Mt = /^(?:!|!!|![a-z\-]+!)$/i, $t = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function pt(e) {
...
var Dt = new Array(256), Ht = new Array(256);
for (var le = 0; le < 256; le++)
  Dt[le] = dt(le) ? 1 : 0, Ht[le] = dt(le);
function nn(e, r) {
...
var ht = {
  YAML: function(r, t, n) {
    var i, o, s;
    r.version !== null && g(r, "duplication of %YAML directive"), n.length !== 1 && g(r, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && g(r, "ill-formed argument of the YAML directive"), o = parseInt(i[1], 10), s = parseInt(i[2], 10), o !== 1 && g(r, "unacceptable YAML version of the document"), r.version = n[0], r.checkLineBreaks = s < 2, s !== 1 && s !== 2 && $e(r, "unsupported YAML version of the document");
  },
  TAG: function(r, t, n) {
    var i, o;
    n.length !== 2 && g(r, "TAG directive accepts exactly two arguments"), i = n[0], o = n[1], Mt.test(i) || g(r, "ill-formed tag handle (first argument) of the TAG directive"), W.call(r.tagMap, i) && g(r, 'there is a previously declared suffix for "' + i + '" tag handle'), $t.test(o) || g(r, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
      o = decodeURIComponent(o);
    } catch {
      g(r, "tag prefix is malformed: " + o);
    }
    r.tagMap[i] = o;
  }
};
  ...
  if (r < t) {
    if (a = e.input.slice(r, t), n)
      for (i = 0, o = a.length; i < o; i += 1)
        s = a.charCodeAt(i), s === 9 || 32 <= s && s <= 1114111 || g(e, "expected valid JSON character");
    else Ji.test(a) && g(e, "the stream contains non-printable characters");
    e.result += a;
  }
}
function ft(e, r, t, n) {
  var i, o, s, a;
  for (E.isObject(t) || g(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(t), s = 0, a = i.length; s < a; s += 1)
...
function pe(e, r, t, n, i, o, s, a, l) {
  ...
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), c = 0, d = i.length; c < d; c += 1)
      Array.isArray(i[c]) && g(e, "nested arrays are not supported inside keys"), typeof i == "object" && pt(i[c]) === "[object Object]" && (i[c] = "[object Object]");
  if (typeof i == "object" && pt(i) === "[object Object]" && (i = "[object Object]"), i = String(i), r === null && (r = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !W.call(t, i) && W.call(r, i) && (e.line = s || e.line, e.lineStart = a || e.lineStart, e.position = l || e.position, g(e, "duplicated mapping key")), i === "__proto__" ? Object.defineProperty(r, i, {
      configurable: !0,
      enumerable: !0,
      writable: !0,
      value: o
...
function A(e, r, t) {
  ...
  return t !== -1 && n !== 0 && e.lineIndent < t && $e(e, "deficient indentation"), n;
}
function qe(e) {
  var r = e.position, t;
...
function on(e, r, t) {
  ...
  if (h = e.input.charCodeAt(e.position), N(h) || ue(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), N(i) || t && ue(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", o = s = e.position, a = !1; h !== 0; ) {
    if (h === 58) {
      ...
      if (e.position === e.lineStart && qe(e) || t && ue(h))
        break;
      if ($(h))
    ...
    a && (Y(e, o, s, !1), it(e, e.line - l), o = s = e.position, a = !1), se(h) || (s = e.position + 1), h = e.input.charCodeAt(++e.position);
  }
  return Y(e, o, s, !1), e.result ? !0 : (e.kind = u, e.result = f, !1);
}
function sn(e, r) {
  var t, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (t = e.input.charCodeAt(e.position)) !== 0; )
    if (t === 39)
      if (Y(e, n, e.position, !0), t = e.input.charCodeAt(++e.position), t === 39)
        ...
        return !0;
    else $(t) ? (Y(e, n, i, !0), it(e, A(e, !1, r)), n = i = e.position) : e.position === e.lineStart && qe(e) ? g(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function an(e, r) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, t = n = e.position; (a = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (a === 92) {
      if (Y(e, t, e.position, !0), a = e.input.charCodeAt(++e.position), $(a))
        A(e, !1, r);
      else if (a < 256 && Dt[a])
        e.result += Ht[a], e.position++;
      else if ((s = en(a)) > 0) {
        for (i = s, o = 0; i > 0; i--)
          a = e.input.charCodeAt(++e.position), (s = Zi(a)) >= 0 ? o = (o << 4) + s : g(e, "expected hexadecimal character");
        e.result += rn(o), e.position++;
      } else
        g(e, "unknown escape sequence");
      t = n = e.position;
    } else $(a) ? (Y(e, t, n, !0), it(e, A(e, !1, r)), t = n = e.position) : e.position === e.lineStart && qe(e) ? g(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  g(e, "unexpected end of the stream within a double quoted scalar");
}
function ln(e, r) {
  var t = !0, n, i, o, s = e.tag, a, l = e.anchor, c, d, u, f, h, m = /* @__PURE__ */ Object.create(null), b, v, C, y;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), y = e.input.charCodeAt(++e.position); y !== 0; ) {
    ...
    t ? y === 44 && g(e, "expected the node content, but found ','") : g(e, "missed comma between flow collection entries"), v = b = C = null, u = f = !1, y === 63 && (c = e.input.charCodeAt(e.position + 1), N(c) && (u = f = !0, e.position++, A(e, !0, r))), n = e.line, i = e.lineStart, o = e.position, ve(e, r, Ue, !1, !0), v = e.tag, b = e.result, A(e, !0, r), y = e.input.charCodeAt(e.position), (f || e.line === n) && y === 58 && (u = !0, y = e.input.charCodeAt(++e.position), A(e, !0, r), ve(e, r, Ue, !1, !0), C = e.result), h ? pe(e, a, m, v, b, C, n, i, o) : u ? a.push(pe(e, null, m, v, b, C, n, i, o)) : a.push(b), A(e, !0, r), y = e.input.charCodeAt(e.position), y === 44 ? (t = !0, y = e.input.charCodeAt(++e.position)) : t = !1;
  }
...
function cn(e, r) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      Ke === i ? i = u === 43 ? ut : Ki : g(e, "repeat of a chomping mode identifier");
    else if ((d = tn(u)) >= 0)
      d === 0 ? g(e, "bad explicit indentation width of a block scalar; it cannot be less than one") : s ? g(e, "repeat of an indentation width identifier") : (a = r + d - 1, s = !0);
    else
      break;
  if (se(u)) {
    do
  ...
  for (; u !== 0; ) {
    ...
    if (!s && e.lineIndent > a && (a = e.lineIndent), $(u)) {
      l++;
      continue;
    }
    if (e.lineIndent < a) {
...
`, l) : e.result += E.repeat(`
`, o ? 1 + l : l), o = !0, s = !0, l = 0, t = e.position; !$(u) && u !== 0; )
      u = e.input.charCodeAt(++e.position);
    Y(e, t, e.position, !1);
  }
  return !0;
...
function mt(e, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, g(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !N(s)))); ) {
...
function un(e, r, t) {
  var n, i, o, s, a, l, c = e.tag, d = e.anchor, u = {}, f = /* @__PURE__ */ Object.create(null), h = null, m = null, b = null, v = !1, C = !1, y;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), y = e.input.charCodeAt(e.position); y !== 0; ) {
    if (!v && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, g(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), o = e.line, (y === 63 || y === 58) && N(n))
      y === 63 ? (v && (pe(e, u, f, h, m, null, s, a, l), h = m = b = null), C = !0, v = !0, i = !0) : v ? (v = !1, i = !0) : g(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, y = n;
    else {
      ...
      if (e.line === o) {
        ...
        if (y === 58)
          y = e.input.charCodeAt(++e.position), N(y) || g(e, "a whitespace character is expected after the key-value separator within a block mapping"), v && (pe(e, u, f, h, m, null, s, a, l), h = m = b = null), C = !0, v = !1, i = !1, h = e.tag, m = e.result;
        else if (C)
    ...
    if ((e.line === o || e.lineIndent > r) && (v && (s = e.line, a = e.lineStart, l = e.position), ve(e, r, Me, !0, i) && (v ? m = e.result : b = e.result), v || (pe(e, u, f, h, m, b, s, a, l), h = m = b = null), A(e, !0, -1), y = e.input.charCodeAt(e.position)), (e.line === o || e.lineIndent > r) && y !== 0)
      g(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < r)
      break;
  }
  return v && pe(e, u, f, h, m, null, s, a, l), C && (e.tag = c, e.anchor = d, e.kind = "mapping", e.result = u), C;
}
function pn(e) {
  var r, t = !1, n = !1, i, o, s;
  if (s = e.input.charCodeAt(e.position), s !== 33) return !1;
  if (e.tag !== null && g(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (t = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", r = e.position, t) {
    do
      s = e.input.charCodeAt(++e.position);
    while (s !== 0 && s !== 62);
    e.position < e.length ? (o = e.input.slice(r, e.position), s = e.input.charCodeAt(++e.position)) : g(e, "unexpected end of the stream within a verbatim tag");
  } else {
    for (; s !== 0 && !N(s); )
      s === 33 && (n ? g(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(r - 1, e.position + 1), Mt.test(i) || g(e, "named tag handle cannot contain such characters"), n = !0, r = e.position + 1)), s = e.input.charCodeAt(++e.position);
    o = e.input.slice(r, e.position), Xi.test(o) && g(e, "tag suffix cannot contain flow indicator characters");
  }
  o && !$t.test(o) && g(e, "tag name cannot contain such characters: " + o);
  try {
    o = decodeURIComponent(o);
  } catch {
    g(e, "tag name is malformed: " + o);
  }
  return t ? e.tag = o : W.call(e.tagMap, i) ? e.tag = e.tagMap[i] + o : i === "!" ? e.tag = "!" + o : i === "!!" ? e.tag = "tag:yaml.org,2002:" + o : g(e, 'undeclared tag handle "' + i + '"'), !0;
}
function dn(e) {
  var r, t;
  if (t = e.input.charCodeAt(e.position), t !== 38) return !1;
  for (e.anchor !== null && g(e, "duplication of an anchor property"), t = e.input.charCodeAt(++e.position), r = e.position; t !== 0 && !N(t) && !ue(t); )
...
function hn(e) {
  ...
  return e.position === r && g(e, "name of an alias node must contain at least one character"), t = e.input.slice(r, e.position), W.call(e.anchorMap, t) || g(e, 'unidentified alias "' + t + '"'), e.result = e.anchorMap[t], A(e, !0, -1), !0;
}
function ve(e, r, t, n, i) {
  var o, s, a, l = 1, c = !1, d = !1, u, f, h, m, b, v;
  ...
  if (a && (a = c || i), (l === 1 || Me === t) && (Ue === t || Ft === t ? b = r : b = r + 1, v = e.position - e.lineStart, l === 1 ? a && (mt(e, v) || un(e, v, b)) || ln(e, b) ? d = !0 : (s && cn(e, b) || sn(e, b) || an(e, b) ? d = !0 : hn(e) ? (d = !0, (e.tag !== null || e.anchor !== null) && g(e, "alias node should not have any properties")) : on(e, b, Ue === t) && (d = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (d = a && mt(e, v))), e.tag === null)
    ...
    if (W.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (m = null, h = e.typeMap.multi[e.kind || "fallback"], u = 0, f = h.length; u < f; u += 1)
...
function fn(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (A(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    for (o = !0, s = e.input.charCodeAt(++e.position), t = e.position; s !== 0 && !N(s); )
      s = e.input.charCodeAt(++e.position);
    for (n = e.input.slice(t, e.position), i = [], n.length < 1 && g(e, "directive name must not be less than one character in length"); s !== 0; ) {
      for (; se(s); )
        s = e.input.charCodeAt(++e.position);
      if (s === 35) {
        do
    ...
    s !== 0 && rt(e), W.call(ht, n) ? ht[n](e, n, i) : $e(e, 'unknown document directive "' + n + '"');
  }
  if (A(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, A(e, !0, -1)) : o && g(e, "directives end mark is expected"), ve(e, e.lineIndent - 1, Me, !1, !0), A(e, !0, -1), e.checkLineBreaks && Qi.test(e.input.slice(r, e.position)) && $e(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && qe(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  ...
  for (n !== -1 && (t.position = n, g(t, "null byte is not allowed in input")), t.input += "\0"; t.input.charCodeAt(t.position) === 32; )
...
var gn = bn, vn = {
  load: gn
}, Bt = Object.prototype.toString, Vt = Object.prototype.hasOwnProperty, nt = 65279, wn = 9, ye = 10, xn = 13, yn = 32, Cn = 33, _n = 34, Qe = 35, Sn = 37, kn = 38, An = 39, En = 42, qt = 44, Ln = 45, De = 58, On = 61, Rn = 62, Tn = 63, Nn = 64, zt = 91, Yt = 93, In = 96, Wt = 123, Pn = 124, Gt = 125, O = {};
O[0] = "\\0";
O[7] = "\\a";
O[8] = "\\b";
O[9] = "\\t";
...
var Dn = 1, Ce = 2;
function Hn(e) {
  this.schema = e.schema || Pt, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = E.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Mn(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Ce : Dn, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function bt(e, r) {
...
function vt(e, r, t) {
  ...
  return (
    ...
    (t ? (
      // c = flow-in
      n
    ) : n && e !== qt && e !== zt && e !== Yt && e !== Wt && e !== Gt) && e !== Qe && !(r === De && !i) || gt(r) && !He(r) && e === Qe || r === De && i
  );
}
function Bn(e) {
  return _e(e) && e !== nt && !He(e) && e !== Ln && e !== Tn && e !== De && e !== qt && e !== zt && e !== Yt && e !== Wt && e !== Gt && e !== Qe && e !== kn && e !== En && e !== Cn && e !== Pn && e !== On && e !== Rn && e !== An && e !== _n && e !== Sn && e !== Nn && e !== In;
}
function Vn(e) {
  return !He(e) && e !== De;
}
...
function qn(e, r, t, n, i, o, s, a) {
  var l, c = 0, d = null, u = !1, f = !1, h = n !== -1, m = -1, b = Bn(we(e, 0)) && Vn(we(e, e.length - 1));
  if (r || s)
  ...
  return !u && !f ? b && !s && !i(e) ? Jt : o === Ce ? ce : Ze : t > 9 && Kt(e) ? ce : s ? o === Ce ? ce : Ze : f ? Xt : Qt;
}
...
function Jn(e, r, t, n) {
  ...
  for (a = 0, l = s.length; a < l; a += 1)
    f = "", (!n || i !== "") && (f += Xe(e, r)), c = s[a], d = t[c], e.replacer && (d = e.replacer.call(t, c, d)), j(e, r + 1, c, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && ye === e.dump.charCodeAt(0) ? f += "?" : f += "? "), f += e.dump, u && (f += Xe(e, r)), j(e, r + 1, d, !0, u) && (e.dump && ye === e.dump.charCodeAt(0) ? f += ":" : f += ": ", f += e.dump, i += f));
  e.tag = o, e.dump = i || "{}";
}
function _t(e, r, t) {
  var n, i, o, s, a, l;
...
function j(e, r, t, n, i, o, s) {
  ...
  if (d && (u = e.duplicates.indexOf(t), f = u !== -1), (e.tag !== null && e.tag !== "?" || f || e.indent !== 2 && r > 0) && (i = !1), f && e.usedDuplicates[u])
    ...
    if (d && f && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), a === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (Jn(e, r, e.dump, i), f && (e.dump = "&ref_" + u + e.dump)) : (Kn(e, r, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    else if (a === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && r > 0 ? Ct(e, r - 1, e.dump, i) : Ct(e, r, e.dump, i), f && (e.dump = "&ref_" + u + e.dump)) : (Gn(e, r, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    ...
    try {
      ...
      if (t.retries > 0 && n <= t.retries && (typeof t.retryOn == "function" ? t.retryOn(c) : t.retryOn.includes(c.status))) {
        ...
        if (t.onRetry && await t.onRetry(n, u), t.onError) {
          const f = new Fe(`请求失败，状态码 ${d.status}`, d.status, c, n);
          await t.onError(f, n);
        }
...
class so {
  constructor(r = []) {
    S(this, "existVps", []);
    S(this, "existVpsMap", /* @__PURE__ */ new Map());
...
class er extends Ne {
   ...
   */
  setConfuseConfig(t) {
    w(this, P, new URL(t)), p(this, P).username = this.getUsername(), p(this, P).host = this.getHost(), p(this, P).hostname = this.getHostName(), p(this, P).port = this.getPort(), p(this, P).hash = k.setPs(p(this, X), p(this, de)), w(this, Ee, p(this, P).href);
  }
  restoreClash(t, n) {
    var i, o, s, a, l, c, d, u, f, h, m;
    if (t.name = n, t.server = this.originConfig.hostname ?? "", t.port = Number(this.originConfig.port ?? 0), t.type === "hysteria2" && z(t, "password")) {
      const b = this.originConfig.username || ((o = (i = this.originConfig) == null ? void 0 : i.searchParams) == null ? void 0 : o.get("password"));
      t.password = b || "default_password";
    }
    if ((s = this.originConfig.searchParams) != null && s.has("insecure") && this.originConfig.searchParams.get("insecure") === "1" && (t["skip-cert-verify"] = !0), (a = this.originConfig.searchParams) != null && a.has("mport")) {
      const b = this.originConfig.searchParams.get("mport");
      b && (t.ports = b, t.mport = b);
    }
    return t.udp = !0, z(t, "down") && (t.down = t.down !== "" ? t.down : ((l = this.originConfig.searchParams) == null ? void 0 : l.get("down")) ?? ((c = this.originConfig.searchParams) == null ? void 0 : c.get("downmbps")) ?? 0), z(t, "up") && (t.up = t.up !== "" ? t.up : ((d = this.originConfig.searchParams) == null ? void 0 : d.get("up")) ?? ((u = this.originConfig.searchParams) == null ? void 0 : u.get("upmbps")) ?? 0), z(t, "delay") && (t.delay = ((f = this.originConfig.searchParams) == null ? void 0 : f.get("delay")) ?? 0), (h = this.originConfig.searchParams) != null && h.has("sni") && (t.sni = ((m = this.originConfig.searchParams) == null ? void 0 : m.get("sni")) ?? ""), t;
  }
  restoreSingbox(t, n) {
    var o, s, a, l;
    const i = this.originConfig.username || ((s = (o = this.originConfig) == null ? void 0 : o.searchParams) == null ? void 0 : s.get("password"));
    if (t.password = i || "default_password", t.server = this.originConfig.hostname ?? "", t.server_port = Number(this.originConfig.port ?? 0), t.tag = n, (a = this.originConfig.searchParams) != null && a.has("insecure") && this.originConfig.searchParams.get("insecure") === "1" && (t["skip-cert-verify"] = !0), (l = this.originConfig.searchParams) != null && l.has("mport")) {
      const c = this.originConfig.searchParams.get("mport");
      c && (t.ports = c, t.mport = c);
    }
    return t.udp = !0, t.down && (t.down = decodeURIComponent(t.down)), t.up && (t.up = decodeURIComponent(t.up)), t;
  }
  /**
   * @description 原始备注
   * @example '#originPs'
...
class tr extends Ne {
  ...
  setOriginConfig(t) {
    ...
    w(this, Z, n), w(this, D, new URL(n)), w(this, ee, p(this, D).hash ?? "");
  }
  /**
   * @description 更新原始配置
   * @param {string} ps
   */
  updateOriginConfig(t) {
    p(this, D).hash = t, w(this, ee, t), w(this, Z, p(this, D).href), this.setConfuseConfig(p(this, Z));
  }
  /**
   * @description 设置混淆配置
   * @param {string} v
   */
  setConfuseConfig(t) {
    w(this, R, new URL(this.toStandard(t))), p(this, R).username = this.getUsername(), p(this, R).host = this.getHost(), p(this, R).hostname = this.getHostName(), p(this, R).port = this.getPort(), p(this, R).hash = k.setPs(p(this, ee), p(this, he)), w(this, Le, `ss://${decodeURIComponent(p(this, D).username)}@${p(this, R).hostname}:${p(this, R).port}${p(this, R).search}#${p(this, R).hash}`);
  }
  restoreClash(t, n) {
    var i;
  ...
  toStandard(t) {
    ...
    try {
      ...
      const f = c.substring(0, u), h = c.substring(u + 1), m = d.lastIndexOf(":");
      if (m === -1)
        throw new Error("Invalid server info: missing port");
      const b = d.substring(0, m), v = d.substring(m + 1);
      if (!f || !h || !b || !v)
...
Z = new WeakMap(), Le = new WeakMap(), D = new WeakMap(), R = new WeakMap(), ee = new WeakMap(), he = new WeakMap();
var te, Oe, V, F, re, fe;
class rr extends Ne {
  constructor(t) {
    super();
   ...
   */
  setOriginConfig(t) {
    w(this, te, t), w(this, V, new URL(t)), w(this, re, k.formatPs(p(this, V).hash) ?? "");
  }
  /**
   * @description 更新原始配置
   * @param {string} ps
   */
  updateOriginConfig(t) {
    p(this, V).hash = k.formatPs(t), w(this, re, k.formatPs(t)), w(this, te, p(this, V).href), this.setConfuseConfig(p(this, te));
  }
  /**
   * @description 设置混淆配置
   * @param {string} v
   */
  setConfuseConfig(t) {
    w(this, F, new URL(t)), p(this, F).username = this.getUsername(), p(this, F).host = this.getHost(), p(this, F).hostname = this.getHostName(), p(this, F).port = this.getPort(), p(this, F).hash = k.setPs(p(this, re), p(this, fe)), w(this, Oe, p(this, F).href);
  }
  restoreClash(t, n) {
    var i;
...
class ir extends Ne {
   ...
   */
  setOriginConfig(t) {
    w(this, ie, t), w(this, q, new URL(t)), w(this, ne, k.formatPs(p(this, q).hash) ?? "");
  }
  /**
   * @description 更新原始配置
   * @param {string} ps
   */
  updateOriginConfig(t) {
    p(this, q).hash = k.formatPs(t), w(this, ne, k.formatPs(t)), w(this, ie, p(this, q).href), this.setConfuseConfig(p(this, ie));
  }
  /**
   * @description 设置混淆配置
   * @param {string} v
   */
  setConfuseConfig(t) {
    w(this, U, new URL(t)), p(this, U).username = this.getUsername(), p(this, U).host = this.getHost(), p(this, U).hostname = this.getHostName(), p(this, U).port = this.getPort(), p(this, U).hash = k.setPs(p(this, ne), p(this, me)), w(this, Re, p(this, U).href);
  }
  restoreClash(t, n) {
    var i, o;
    return Ye(this, Be, nr).call(this, t), t.name = n, t.server = this.originConfig.hostname ?? "", t.port = Number(((i = this.originConfig) == null ? void 0 : i.port) ?? 0), t.uuid = this.originConfig.username ?? "", t.alpn = t.alpn ? (o = t.alpn) == null ? void 0 : o.map((s) => decodeURIComponent(s)) : t.alpn, t.udp = !0, t.tfo && delete t.tfo, t;
  }
  restoreSingbox(t, n) {
    return t.tag = n, t.server = this.originConfig.hostname ?? "", t.server_port = Number(this.originConfig.port ?? 0), t.uuid = this.originConfig.username ?? "", t.udp = !0, t.tfo && delete t.tfo, t;
  }
  /**
   * @description 原始备注
   * @example '#originPs'
...
ie = new WeakMap(), Re = new WeakMap(), q = new WeakMap(), U = new WeakMap(), ne = new WeakMap(), me = new WeakMap(), Be = new WeakSet(), nr = function(t) {
  ...
  t.network === "ws" && (t["ws-opts"] = {
    ...
    headers: {
      ...t["ws-opts"].headers,
      Host: ((i = this.originConfig.searchParams) == null ? void 0 : i.get("host")) ?? this.originConfig.host
    }
  });
};
...
class or extends Ne {
   ...
   */
  setConfuseConfig() {
    w(this, M, structuredClone(p(this, H))), p(this, M).add = this.getHostName(), p(this, M).port = this.getPort(), p(this, M).id = this.getPassword(), p(this, M).ps = k.setPs(p(this, oe), p(this, ge)), w(this, Te, `vmess://${G(JSON.stringify(p(this, M)))}`);
  }
  restoreClash(t, n) {
    var i, o;
...
function co(e) {
  if (!e || !e.server || !e.port)
    throw new Error("Hysteria2 configuration object must contain server and port.");
  const r = e.server, t = e.port, n = e.password || "default_password", i = e.name || "", o = new URLSearchParams();
  o.append("password", n);
  const s = e.sni || e.servername || e.server;
  s && o.append("sni", s), (e.insecure || e["skip-cert-verify"] || e["skip-cert-verify"] === !0 || e["skip-cert-verify"] === !1) && o.append("insecure", "1"), e.alpn && (typeof e.alpn == "string" || Array.isArray(e.alpn)) && o.append("alpn", Array.isArray(e.alpn) ? e.alpn.join(",") : e.alpn), e.obfs && o.append("obfs", e.obfs), e["obfs-param"] && o.append("obfs-param", e["obfs-param"]), e["obfs-password"] && o.append("obfs-password", e["obfs-password"]);
...
function uo(e) {
  ...
  switch (c) {
    ...
    case "http": {
      ...
      let m;
      h.headers && h.headers.Host ? m = h.headers.Host : e.sni || e.servername ? m = e.sni || e.servername : m = e.server, m && l.append("host", m);
      const b = h.path || "/";
      b !== "/" && l.append("path", b);
      break;
    }
...
function po(e) {
  ...
  const h = f.toString();
  h && (u += `?${h}`);
  const m = Pe(u), b = encodeURIComponent(c);
  let v = `ssr://${m}`;
  return c && (v += `#${b}`), v;
}
function ho(e) {
...
function fo(e) {
  ...
  switch (s) {
    ...
    case "grpc":
      ...
      break;
    case "quic":
      a !== "tls" && a !== "reality" && (o.has("security") || o.set("security", "tls")), e["quic-opts"] && (e["quic-opts"].security && e["quic-opts"].security !== "none" && o.set("quicSecurity", encodeURIComponent(e["quic-opts"].security)), e["quic-opts"].key && o.set("key", encodeURIComponent(e["quic-opts"].key)), (b = e["quic-opts"].header) != null && b.type && e["quic-opts"].header.type !== "none" && o.set("headerType", e["quic-opts"].header.type));
      break;
    case "httpupgrade":
...
class ar extends ao {
  constructor(t, n = [], i = "") {
    super(n);
    S(this, "urlSet", /* @__PURE__ */ new Set());
    S(this, "vpsStore", /* @__PURE__ */ new Map());
    S(this, "originUrls", /* @__PURE__ */ new Set());
    S(this, "subscriptionHeaders", /* @__PURE__ */ new Map());
    S(this, "vps", []);
    S(this, "includeProtocol", []);
  ...
  async parse(t = this.vps) {
    for await (const n of t)
      try {
        ...
        if (i) {
          let o = null;
          i.startsWith("vless://") && this.hasProtocol("vless") ? o = new ir(i) : i.startsWith("vmess://") && this.hasProtocol("vmess") ? o = new or(i) : i.startsWith("trojan://") && this.hasProtocol("trojan") ? o = new rr(i) : i.startsWith("ss://") && this.hasProtocol("shadowsocks") ? o = new tr(i) : this.isHysteria2(i) && this.hasProtocol("hysteria", "hysteria2", "hy2") && (o = new er(i)), o ? this.setStore(i, o) : console.warn(`Failed to create parser for: ${i}`);
        }
          ...
          try {
            ...
            try {
              if (o.headers) {
                const c = o.headers;
                let d = null;
                c.get && typeof c.get == "function" ? d = c.get("subscription-userinfo") : c["subscription-userinfo"] && (d = c["subscription-userinfo"]), d && (this.subscriptionHeaders.set(n, d), console.log(`Found subscription-userinfo for ${n}: ${d}`));
              }
            } catch (c) {
              console.warn(`Failed to access headers for ${n}:`, c);
            }
            const { subType: a, content: l } = this.getSubType(s);
            if (a === "base64" && l && (this.updateExist(Array.from(this.originUrls)), await this.parse(l.split(`
`).filter(Boolean))), a === "yaml" && l) {
              const c = l.proxies;
              if (c && c.length) {
                this.updateExist(Array.from(this.originUrls));
                const d = bo(c);
                await this.parse(d.filter(Boolean));
              } else
                console.warn(`No proxies found in YAML content from: ${n}`);
            }
          } catch (o) {
            console.error(`Failed to fetch subscription from ${n}:`, o);
            continue;
          }
      } catch (i) {
        console.error(`Failed to parse URL ${n}:`, i);
        continue;
      }
  }
  setStore(t, n) {
  ...
  get subscriptionUserinfo() {
    for (const [t, n] of this.subscriptionHeaders)
      return n;
  }
}
let go = class {
  ...
  mergeClashConfig(r = []) {
    ...
    try {
      ...
      const a = {
        ...
        var b;
        return h + (((b = m.proxies) == null ? void 0 : b.length) || 0);
      ...
      for (let h = 1; h < r.length; h++) {
        ...
        if ((i = m.proxies) != null && i.length)
          for (const b of m.proxies)
            d.has(b.name) || (a.proxies[u] = b, c[u] = u, d.add(b.name), u++);
        if ((o = m["proxy-groups"]) != null && o.length)
          for (const b of m["proxy-groups"]) {
            const v = f.get(b.name);
            if (v) {
              const C = new Set(v.proxies);
              for (const y of b.proxies || [])
                C.add(y);
              ...
              a["proxy-groups"].push(b), f.set(b.name, b);
          }
      }
      return a.proxies = a.proxies.filter((h, m) => c[m] !== -1), a;
    } catch (s) {
        ...
        if ((t = l.outbounds) != null && t.length) {
          for (const c of l.outbounds)
            if (c.outbounds) {
              ...
              if (!a.has(d)) {
                const u = new Set(c.outbounds.filter((f) => !k.isConfigType(f)));
                a.set(d, {
                  base: c,
                  baseOutbounds: u,
              ...
              c.outbounds.forEach((u) => {
                var f;
                k.isConfigType(u) && ((f = a.get(d)) == null || f.linkOutbounds.add(u));
              });
            }
        }
      for (const l of r)
...
class xo {
  constructor(r) {
    S(this, "urls", []);
    S(this, "vps", []);
    S(this, "chunkCount", Number(Ie.CHUNK_COUNT));
    S(this, "backend", Ie.BACKEND);
    S(this, "parser", null);
    S(this, "clashClient", new go());
    S(this, "singboxClient", new vo());
    S(this, "v2rayClient", new wo(this.vps));
  ...
  get subscriptionUserinfo() {
    var r;
    return (r = this.parser) == null ? void 0 : r.subscriptionUserinfo;
  }
}
class yo {
  constructor(r) {
    S(this, "confuseConfig");
    ...
    for (const i of r)
      try {
        if (this.isConfuseVps(i.tag)) {
          const [o, s] = k.getPs(i.tag), a = t.get(s);
...
class ko {
  ...
  async toSub(r, t, n) {
    try {
      ...
      const o = new So(i);
      let s, a;
      if (i.subscriptionUserinfo && (a = i.subscriptionUserinfo), ["clash", "clashr"].includes(n)) {
        const l = await o.getClashConfig();
        s = new Response(to(l, { indent: 2, lineWidth: 200 }), {
          headers: new Headers({
        ...
        s = new Response(JSON.stringify(l), {
          headers: new Headers({
        ...
        const l = await o.getV2RayConfig();
        s = new Response(l, {
          headers: new Headers({
            "Content-Type": "text/plain; charset=UTF-8",
            "Cache-Control": "no-store"
      ...
      return a && s.headers.set("subscription-userinfo", a), s;
    } catch (i) {
